...
public class BtnLogin extends Button implements EventHandler<ActionEvent> {
	
	public BtnLogin(ActionEvent event, String wsusPath)
	{	
	...
	final static Logger logger = Logger.getLogger(BtnLogin.class);
